...
<body>
    ...
    <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="?page=cadastrar-medicamento">Cadastrar Medicamento</a></li>
        <li><a class="dropdown-item" href="?page=listar-medicamento">Listar Estoque</a></li>
    </ul>
</li>
	      </ul>
				...
				<?php
					...
					switch (@$_REQUEST['page']) {
						...
						case 'salvar-consulta':
							...
							break;
						case 'cadastrar-medicamento':
							include('cadastrar-medicamento.php');
							break;
						case 'editar-medicamento':
							include('editar-medicamento.php');
							break;
						case 'listar-medicamento':
							include('listar-medicamento.php');
							break;
						case 'salvar-medicamento':
